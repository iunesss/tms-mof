...
const CATEGORY_TERMS = {
  ...
  AGENT: { NOMINATIONS: ['NOMINATION', 'CANDIDATE'], DOCUMENTS: ['DOCUMENT', 'FORM'], COURSES: ['COURSE', 'MISSION', 'INVITATION'] },
  DEPARTMENT_MANAGER: { NOMINATIONS: ['NOMINATION', 'CANDIDATE'], DOCUMENTS: ['DOCUMENT', 'FORM'], COURSES: ['COURSE', 'MISSION', 'INVITATION'] },
